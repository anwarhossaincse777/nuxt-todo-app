...
const courses = await $fetch('https://dummyjson.com/products?limit=3')
...
<template>
  ...
  <div class="bg-white rounded grap-10 overflow-hidden shadow-card" v-for="course in courses.products" :key="course.id">
    <router-link :to="{ name: 'single-course' }">
      <img :src="course.thumbnail" alt="PEST Driven Laravel" class="w-full h-auto object-contain">
    </router-link>
    <div class="px-6 pb-5">
